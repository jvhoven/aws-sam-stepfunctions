...
```bash
aws-sam-stepfunctions$ sam build
```
...
```bash
aws-sam-stepfunctions$ sam logs -n StockCheckerFunction --stack-name aws-sam-stepfunctions --tail
```
...
```bash
aws-sam-stepfunctions$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name aws-sam-stepfunctions
```
